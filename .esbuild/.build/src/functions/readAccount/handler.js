...
// src/functions/readAccount/handler.ts
__export(exports, {
  main: () => main
});
...
var hello = async (event) => {
  ...
  const response = await import_axios.default.get(`https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365184650450/account/${id}?minorversion=62`, {
