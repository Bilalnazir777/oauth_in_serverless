...
var createAccount = async (event) => {
  ...
  console.log(Data);
  const response = await import_axios.default.post("https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365184650450/account?minorversion=62", Data, { headers: { Authorization: `Bearer ${token}` } });
