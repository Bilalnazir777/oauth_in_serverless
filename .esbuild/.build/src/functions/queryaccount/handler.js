...
var queryaccount = async (event) => {
  ...
  const response = await import_axios.default.get("https://sandbox-quickbooks.api.intuit.com/v3/company/4620816365184650450/query?query=select * from Account where Metadata.CreateTime > '2014-12-31'&minorversion=62", { headers: { Authorization: `Bearer ${token}` } });
